...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='E:\\replay_pilot_eeg\\replay_pilot\\cued_mental_stim.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_rating_question = visual.TextStim(win=win, name='text_rating_question',
        text='How vivid was your mental simulation?',
        font='Arial',
    ...
    for thisTrials_loop in trials_loop:
        ...
        trial = data.Routine(
            name='trial',
            components=[cue_stim, fixation_stim, probe_image, key_resp_probe],
        )
        ...
        while continueRoutine:
            ...
            if prob_image.status == STARTED and wait_sent_img = 0: #If the stimulus component has started and the trigger has not yet been sent. Change 'stimulus' to match the name of the component you want the trigger to be sent at the same time as
